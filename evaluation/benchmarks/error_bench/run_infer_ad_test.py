...
def process_instance(
    ...
    if cfg.explain_plot:
        instruction += 'IF YOU GENERATE A PLOT, YOU MUST PROVIDE INTERPRETATION OF THIS PLOT IN THE NEXT MESSAGE. IF YOU GENERATE MULTIPLE PLOTS, PROVIDE ONE INTERPRETATION FOR EACH PLOT. PUT YOUR EXPLANATION IN </PLOTINTERPRETATION> - PLOT 1: - PLOT 2: ... <PLOTINTERPRETATION>.\n'
