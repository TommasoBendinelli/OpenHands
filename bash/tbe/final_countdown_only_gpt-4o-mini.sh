...
instances=channel_corr,channel_divergence,cofounded_group_outlier,common_frequency,dominant_feature,find_peaks,ground_mean_threashold,outlier_ratio,periodic_presence,predict_ts_stationarity,row_max_abs,row_variance,sign_rotated_generator,simultanus_spike,sum_threshold,variance_burst,zero_crossing
