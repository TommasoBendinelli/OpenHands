...
#   replay_trajectory_path="output.json" \
#   -m
...
# evaluation/evaluation_outputs/outputs/2025-07-30/2025-07-30_08-36-05_0/variance_burst/DataScienceBenchAgent/gemini-2.5-flash_maxiter_30_N_temp/output.jsonl
