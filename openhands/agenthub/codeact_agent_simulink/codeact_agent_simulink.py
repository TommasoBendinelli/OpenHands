...
import openhands.agenthub.codeact_agent_simulink.function_calling as codeact_function_calling
from openhands.agenthub.codeact_agent_simulink.tools.bash import create_cmd_run_tool
from openhands.agenthub.codeact_agent_simulink.tools.browser import BrowserTool
from openhands.agenthub.codeact_agent_simulink.tools.condensation_request import (
    CondensationRequestTool,
)
from openhands.agenthub.codeact_agent_simulink.tools.finish import FinishTool
from openhands.agenthub.codeact_agent_simulink.tools.ipython import IPythonTool
from openhands.agenthub.codeact_agent_simulink.tools.llm_based_edit import (
    LLMBasedFileEditTool,
)
from openhands.agenthub.codeact_agent_simulink.tools.str_replace_editor import (
    create_str_replace_editor_tool,
)
from openhands.agenthub.codeact_agent_simulink.tools.think import ThinkTool
...
class CodeActAgentSimulink(Agent):
    VERSION = '2.2'
    """
    ...
    def __init__(
        ...
        # TODO: Do we need anything specific from data_science_agent.function_calling?
        # Otherwise we use codeact_agent.function_calling
    ...
    def _get_tools(self) -> list['ChatCompletionToolParam']:
        ...
        if self.config.enable_finish and not self.cfg:
