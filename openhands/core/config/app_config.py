...
class AppConfig(BaseModel):
    ...
    Attributes:
        ...
        max_budget_per_task: Maximum cumulative budget per task in USD. Set to 0 or None for no limit; agent stops if exceeded.
    ...
    max_budget_per_task: float | None = Field(
        default=None,
        description=(
            'Maximum cumulative budget per task in USD. 0 or None means unlimited.'
        ),
    )
